import { AstroIcon, ReactIcon, SupabaseIcon, TailwindIcon } from '@/components/Icons'

export const works = [
	{
		id: 1,
		domain: 'thecultureclan.com',
		description:
	...
	},
	{
		...
		stack: [AstroIcon, ReactIcon, TailwindIcon, SupabaseIcon]
	}
]
