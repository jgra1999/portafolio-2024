...
export function ProjectCard({
	...
	return (
		<div>
			...
			<div className='bg-[#0c0c0c]/70 py-5 px-4 text-start rounded-b-xl h-[343px] flex flex-col justify-between'>
				<div>
					<h4 className='font-bold text-2xl'>{name}</h4>
					<p className='text-white text-sm mt-2'>
						{language === 'en' ? description1_en : description1_es}
					</p>
					{description2_es && (
						<p className='text-white text-sm mt-2'>{description2_es}</p>
					)}
				</div>
